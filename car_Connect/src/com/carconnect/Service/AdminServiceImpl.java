...
public class AdminServiceImpl implements IAdminService {
	...
	IAdmindao adminservicedao = new AdminImpldao();

	@Override
	public void getAdminById(int adminid) {

		try {
			Admin admin1 = adminservicedao.getAdminById(adminid);
	...
	public void getAdminByUsername(String username) {
		...
		try {
			Admin admin = adminservicedao.getAdminByUsername(username);
	...
	public void updateAdmin(Admin admin) {
		try {
			adminservicedao.updateAdmin(admin);
		} catch (Exception e) {
			e.getMessage();
		}
	...
	public boolean Authenticate(int adminid, String password) {
		String tmpPassword = adminservicedao.getPassword(adminid);
